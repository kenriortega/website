...
Llegado a este punto ya nos encontramos en condiciones para usar nuestra base de datos en futuros proyectos. Por lo que en próximos articúlos estaremos abordando temas como seguridad, clusters y programación usando lenguajes de programación. Espero que te sea de utilidad este contenido y nos vemos en el próximo capítulo.
